...
param(
  [string]$MeowRoot = "D:\myFiles\dsh\dsh-meow"
)
...
Get-ChildItem (Join-Path $MeowRoot "packages") -Directory -Recurse -Depth 2 -ErrorAction SilentlyContinue | ForEach-Object { Try-Link $_ }
