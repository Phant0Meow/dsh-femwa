...
// client-ui 拆出件（2026-08-26 结构整理）：store/样式/节点/直播渲染件原样迁出。
import { ensureFemStreamStyles } from './client-ui/styles'
import { femStreamAcquire } from './client-ui/stream-store'
import { FemwaChatNodeView, femwaChatDefinition, type FemwaChatData } from './client-ui/chat-node'
...
// dsh-femwa/chat 节点定义与视图 → 已迁至 client-ui/chat-node.tsx（2026-08-26 整理）


// 导演直播锚点节点 → 已迁至 client-ui/director-node.tsx（2026-08-26 整理）


// FemwaChatNodeView → 已迁至 client-ui/chat-node.tsx（2026-08-26 整理）
